...
>>>>>>> Stashed changes
  ...
  }, [organizationId, setErrorMessage, setScreen, step, validateOrganization, setLoadingMessage, setOrganizationId])
...
<<<<<<< Updated upstream
  // Step 3: Set screen based on session validity
=======
  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-y-4 p-4 text-muted-foreground">
        ...
        <p className="text-sm">
          {loadingMessage || "Invalid configuration"}
        </p>
      </div>
    </>
  );
